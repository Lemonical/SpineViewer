...
/// <summary>
/// Drives real-time Spine 4.1.00 preview rendering for the viewport.
/// </summary>
internal sealed class Spine41RuntimePreviewDriver : ISpineRuntimePreviewDriver
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Spine41RuntimePreviewDriver"/> class.
    /// </summary>
    /// <param name="atlasPath">The atlas file path.</param>
    /// <param name="skeletonPath">The skeleton file path.</param>
    public Spine41RuntimePreviewDriver(
        string atlasPath,
        string skeletonPath)
    {
        ...
        foreach (Slot slot in _skeleton.DrawOrder)
        {
            ...
            switch (attachment)
            {
                case RegionAttachment regionAttachment:
                    ...
                    regionAttachment.ComputeWorldVertices(slot, quadVertices, 0);
    ...
    private static SkeletonData LoadSkeletonData(
        ...
        string skeletonPath)
    {
        SkeletonLoader loader = string.Equals(Path.GetExtension(skeletonPath), ".json", StringComparison.OrdinalIgnoreCase)
