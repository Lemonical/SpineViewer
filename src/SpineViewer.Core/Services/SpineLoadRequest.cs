...
/// <summary>
/// Describes the adapter-scoped input needed to load a Spine project.
/// </summary>
public sealed record SpineLoadRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SpineLoadRequest"/> class.
    /// </summary>
